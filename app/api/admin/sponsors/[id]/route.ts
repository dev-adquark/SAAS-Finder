...
export async function PATCH(req: Request, { params }: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    const startsAt = b.startsAt === undefined ? current.startsAt : b.startsAt === null ? null : new Date(b.startsAt);
    const endsAt = b.endsAt === undefined ? current.endsAt : b.endsAt === null ? null : new Date(b.endsAt);
  ...
  } catch { return NextResponse.json({ error: "Invalid sponsor update" }, { status: 400 }); }
}
