...
export default async function DataQuality() {
  ...
  const { totals: t, perProduct } = await dataQuality();
  return (
    <AdminPage title="Data quality">
      ...
      <section className="panel section-gap">
        ...
        <table className="admin-table">
          <thead><tr><th>Product</th><th>Pricing</th><th>Sources</th><th>Facts</th><th>Content</th><th>Review</th><th>Affiliate</th></tr></thead>
          <tbody>
            {perProduct.map((p) => (
              <tr key={p.id}>
