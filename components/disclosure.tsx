...
export function AffiliateDisclosure() {
  return (
    <aside className="disclosure" data-disclosure="affiliate" aria-label="Affiliate disclosure">
      <strong>Disclosure:</strong> Some outbound links on this page may be affiliate links. If you buy through one, SaaSFinder may earn a
      commission at no extra cost to you. Commissions and sponsorships never decide which products we include or how we rank them.{" "}
