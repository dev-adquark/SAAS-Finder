...
(async () => {
  ...
  for (const p of ["/admin", "/admin/products", "/admin/products/new", "/admin/categories", "/admin/use-cases", "/admin/alternatives", "/admin/comparisons", "/admin/pricing", "/admin/affiliates", "/admin/sponsors", "/admin/refreshes", "/admin/analytics"]) {
  ...
  console.log("admin UI e2e passed (login, 12 sections, save, publish gate, unauthenticated action rejected)");
})();
